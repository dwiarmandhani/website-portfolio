						...
						<?php foreach ($pengaturan as $p) { ?>
							...
							<form method="post" action="<?php echo base_url('dashboard/pengaturan_update') ?>" enctype="multipart/form-data">
								<div class="box-body">
									...
									<div class="form-group">
										<label>Role</label>
										<input type="text" name="role" class="form-control" placeholder="Masukkan Role .." value="<?php echo $p->role; ?>">
										<?php echo form_error('role'); ?>
									</div>
									<div class="form-group">
										<label>About Description</label>
										<input type="text" name="aboutdesc" class="form-control" placeholder="Masukkan About .." value="<?php echo $p->aboutdesc; ?>">
										<?php echo form_error('aboutdesc'); ?>
									</div>

									<div class="form-group">
										<label>Background Intro</label>
										<input type="file" name="bg_intro">
										<small>Kosongkan jika tidak ingin mengubah Backgroun</small>
									</div>
									<hr>
									...
									<div class="form-group">
										...
										<small>Kosongkan jika tidak ingin mengubah Profile Picture</small>
									</div>
									<div class="form-group">
